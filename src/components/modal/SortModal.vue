...
<template>
  <div
    class="absolute top-full -right-3 translate-y-3 flex flex-col gap-1 bg-neutral-300 border border-neutral-700/70 p-2 cursor-default rounded-lg"
    data-cy="sortModal"
  >
    <div
    ...
    >
      <label
        :for="option.value"
        class="relative w-4 h-4 flex items-center justify-center text-neutral-900 border border-neutral-500 hover:bg-neutral-400/30 cursor-pointer rounded group/sort"
