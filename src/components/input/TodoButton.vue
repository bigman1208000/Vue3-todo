...
<template>
  <button
    ...
    :class="{
      ...
      'text-neutral-500 dark:text-neutral-500 bg-neutral-400': isDisabled,
      'text-neutral-800 dark:text-neutral-300 bg-neutral-300 hover:bg-neutral-500/50':
        isIconButton,
      'text-neutral-800 dark:text-neutral-300 bg-neutral-300 hover:bg-neutral-500/50 dark:hover:bg-neutral-700':
